...
public class Pomscenario1 {
	  private WebDriver driver;
	    WebDriverWait wait;

	    public Pomscenario1(WebDriver driver) {
	        this.driver = driver;
	    }
	    ...
	    private By lastcontinue = By.xpath("//a[@data-qa=\"continue-button\"]");
	    ...
	    public void lastcontinuebutton() {
	    	WebElement lastelement= driver.findElement(lastcontinue);
	    	lastelement.click();
	    }
