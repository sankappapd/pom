...
public class Pomscenario16_17_18 {
	private WebDriver driver;
    WebDriverWait wait;

    public Pomscenario16_17_18(WebDriver driver) {
        this.driver = driver;
    }
 private By usernameInput = By.xpath("//input[@placeholder='Username']");
    ...
    private By edit = By.xpath("(//i[@class=\"oxd-icon bi-pencil-fill\"])[1]");
    private By editname = By.xpath("(//input[@class=\"oxd-input oxd-input--active\"])[2]");
    ...
    public void cancell() {
        WebElement cancelButtonElement = driver.findElement(cancel);
        cancelButtonElement.click();
    }
    public void edit() {
        WebElement editButtonElement = driver.findElement(edit);
        editButtonElement.click();
    }
    public void editnaeminput(String ename) {
        WebElement editnameButtonElement = driver.findElement(editname);
        editnameButtonElement.clear();
        editnameButtonElement.sendKeys(ename);
    }
    public void save() {
