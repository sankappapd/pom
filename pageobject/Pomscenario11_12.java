...
public class Pomscenario11_12 {
	 private WebDriver driver;
	    WebDriverWait wait;

	    public Pomscenario11_12(WebDriver driver) {
	        this.driver = driver;
	    }
	    ...
	    private By Edit = By.xpath("//div[@role='table']//div[1]//div[1]//div[5]//div[1]//button[2]//i[1]");
	    ...
	    public void edit() {
	    	 WebElement editElement=driver.findElement(Edit);
	    	 editElement.click();	
